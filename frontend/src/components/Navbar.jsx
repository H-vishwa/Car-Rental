...
{/*       initial={{ y: -20, opacity: 0 }}
      ...
      <Link to="/">
        <motion.img whileHover={{ scale: 1.1 }} src={assets.logo} alt="Logo" className="h-8" />
      </Link>
      ...
      <div
        ...
        <div className="hidden lg:flex items-center text-sm gap-2 border-[1px] border-borderColor px-3 rounded-full max-w-56">
          <input
            type="text"

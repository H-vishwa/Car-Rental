...
const Dashboard = () => {
  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1 overflow-hidden">
      ...
      />
      <div className="grid gap-6 my-8 max-w-3xl sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      ...
      <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
        ...
        <div className="p-4 md:p-6 mb-6 border border-borderColor rounded-md md:max-w-xs w-full">
          ...
          <p className="text-3xl mt-6 font-semibold bg-gradient-to-tl from-slate-800 via-violet-500 to-zinc-400 bg-clip-text text-transparent">
            {currency}
            {data.monthlyRevenue}
          </p>
        </div>
